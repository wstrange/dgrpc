...
final _builders = <_i1.BuilderApplication>[
  ...
  _i1.apply(r'build_web_compilers:entrypoint', [_i3.webEntrypointBuilder],
      ...
      defaultDevOptions: const _i5.BuilderOptions({
        r'dart2js_args': [r'--enable-asserts']
      }),
      defaultReleaseOptions:
          const _i5.BuilderOptions({r'compiler': r'dart2js'}),
      appliesBuilders: const [
  ...
  _i1.applyPostProcess(r'build_web_compilers:dart2js_archive_extractor',
      ...
      defaultReleaseOptions:
          const _i5.BuilderOptions({r'filter_outputs': true})),
  _i1.applyPostProcess(
      r'build_web_compilers:dart_source_cleanup', _i3.dartSourceCleanup,
      defaultReleaseOptions: const _i5.BuilderOptions({r'enabled': true}))
];

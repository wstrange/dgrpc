define(['dart_sdk', 'packages/collection/src/canonicalized_map'], (function load__packages__async__async(dart_sdk, packages__collection__src__canonicalized_map) {
  ...
  cancelable_operation.CancelableCompleter$ = dart.generic(T => {
    ...
    class CancelableCompleter extends core.Object {
      get operation() {
        let t14, t13;
        t13 = this[__CancelableCompleter_operation];
        return t13 == null ? (t14 = new (__t$CancelableOperationOfT()).__(this), this[__CancelableCompleter_operation] == null ? this[__CancelableCompleter_operation] = t14 : dart.throw(new _internal.LateError.fieldADI("operation"))) : t13;
      }
      static ['_#new#tearOff'](T, opts) {
        let onCancel = opts && 'onCancel' in opts ? opts.onCancel : null;
      ...
      complete(value = null) {
        ...
        if (!__t$FutureOfT().is(value)) {
          t13 = this[_completeNow]();
          t13 == null ? null : t13.complete(value);
          return;
        }
        ...
        value.then(core.Null, dart.fn(result => {
          let t13;
          t13 = this[_completeNow]();
          t13 == null ? null : t13.complete(result);
        }, __t$TToNull()), {onError: dart.fn((error, stackTrace) => {
            let t13;
            t13 = this[_completeNow]();
            t13 == null ? null : t13.completeError(error, stackTrace);
          }, T$.ObjectAndStackTraceToNull())});
      }
      [_completeNow]() {
    ...
    class StreamZip extends async.Stream$(core.List$(T)) {
      ...
      listen(onData, opts) {
        ...
        function controller$35get() {
          let t14;
          t14 = controller;
          return t14 == null ? dart.throw(new _internal.LateError.localNI("controller")) : t14;
        }
        dart.fn(controller$35get, __t$VoidToStreamControllerOfListOfT());
        function controller$35set(t15) {
          return controller = t15;
        }
        ...
        function current$35get() {
          let t18;
          t18 = current;
          return t18 == null ? dart.throw(new _internal.LateError.localNI("current")) : t18;
        }
        dart.fn(current$35get, __t$VoidToListOfTN());
        function current$35set(t19) {
          return current = t19;
        }
  ...
  future_group.FutureGroup$ = dart.generic(T => {
    ...
    class FutureGroup extends core.Object {
      ...
      get onIdle() {
        let t22;
        return (t22 = this[_onIdleController], t22 == null ? this[_onIdleController] = async.StreamController.broadcast({sync: true}) : t22).stream;
      }
      add(task) {
  ...
  stream_queue._TransactionRequest$ = dart.generic(T => {
    ...
    class _TransactionRequest extends core.Object {
      get transaction() {
        let t27;
        t27 = this[___TransactionRequest_transaction];
        return t27 == null ? dart.throw(new _internal.LateError.fieldNI("transaction")) : t27;
      }
      set transaction(t27) {
        if (this[___TransactionRequest_transaction] == null)
          this[___TransactionRequest_transaction] = t27;
        else
      ...
      update(events, isDone) {
        ...
        while (this[_eventsSent] < events.length) {
          events._get((t28 = this[_eventsSent], this[_eventsSent] = t28 + 1, t28)).addTo(this[_controller$1]);
        }
  ...
  stream_group.StreamGroup$ = dart.generic(T => {
    ...
    class StreamGroup extends core.Object {
      ...
      get [_controller$2]() {
        let t28;
        t28 = this[__StreamGroup__controller];
        return t28 == null ? dart.throw(new _internal.LateError.fieldNI("_controller")) : t28;
      }
      set [_controller$2](t28) {
        this[__StreamGroup__controller] = t28;
      }
      get isClosed() {
      ...
      get onIdle() {
        let t29;
        return (t29 = this[_onIdleController$], t29 == null ? this[_onIdleController$] = T$.StreamControllerOfvoid().broadcast() : t29).stream;
      }
      ...
      remove(stream) {
        ...
        let future = (t29 = subscription, t29 == null ? null : t29.cancel());
        if (this[_subscriptions][$isEmpty]) {
          t29$ = this[_onIdleController$];
          t29$ == null ? null : t29$.add(null);
          if (this[_closed$2]) {
            t29$0 = this[_onIdleController$];
            t29$0 == null ? null : t29$0.close();
      ...
      [_onListen$]() {
        ...
        for (let entry of (() => {
          let t29 = __t$ListOfMapEntryOfStreamOfT$StreamSubscriptionNOfT().of(this[_subscriptions][$entries]);
          return t29;
        })()) {
          ...
          try {
            ...
            let error = dart.getThrown(e);
            if (core.Object.is(error)) {
              t31 = this[_onCancel$0]();
              t31 == null ? null : t31.catchError(dart.fn(_ => {
              }, T$.dynamicToNull()));
              dart.rethrow(e);
            } else
              throw e;
  ...
  stream_closer.StreamCloser$ = dart.generic(T => {
    ...
    class StreamCloser extends async.StreamTransformerBase$(T, T) {
      close() {
        let t32;
        t32 = this[_closeFuture];
        return t32 == null ? this[_closeFuture] = dart.fn(() => {
          let futures = (() => {
            let t33 = T$.JSArrayOfFutureOfvoid().of([]);
            for (let subscription of this[_subscriptions$])
              t33.push(subscription.cancel());
            return t33;
          })();
          this[_subscriptions$].clear();
        ...
        }, T$.VoidToFutureOfListOfvoid())() : t32;
      }
      get isClosed() {
  ...
  single_subscription_transformer.SingleSubscriptionTransformer$ = dart.generic((S, T) => {
    ...
    class SingleSubscriptionTransformer extends async.StreamTransformerBase$(S, T) {
      ...
      bind(stream) {
        ...
        function subscription$35set(t35) {
          return subscription = t35;
        }
    ...
    class AsyncCache extends core.Object {
      ...
      fetch(callback) {
        ...
        return async.async(T, (function* fetch() {
          ...
          t38 = this[_cachedValueFuture];
          return t38 == null ? this[_cachedValueFuture] = (t39 = callback(), (() => {
            async['FutureExtensions|ignore'](T, t39.whenComplete(dart.bind(this, _startStaleTimer)));
            return t39;
          })()) : t38;
        }).bind(this));
      }
      fetchStream(callback) {
        ...
        let splitter = (t38 = this[_cachedStreamSplitter], t38 == null ? this[_cachedStreamSplitter] = new (__t$StreamSplitterOfT()).new(callback().transform(T, new (__t$_StreamHandlerTransformerOfT$T()).new({handleDone: dart.fn(sink => {
            this[_startStaleTimer]();
            sink.close();
          }, __t$EventSinkOfTTovoid())}))) : t38);
        return splitter.split();
      }
      invalidate() {
        let t38, t38$;
        this[_cachedValueFuture] = null;
        t38 = this[_cachedStreamSplitter];
        t38 == null ? null : t38.close();
        this[_cachedStreamSplitter] = null;
        t38$ = this[_stale];
        t38$ == null ? null : t38$.cancel();
        this[_stale] = null;
      }
      [_startStaleTimer]() {
